...
@section('content')
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box">
                    ...
                    <form class="form-horizontal" role="form" id="addForm" action="{{route('category.store')}}" method="post">
    ...
    <div id="dataEdit" class="modal-demo">
        ...
        <div class="custom-modal-text">
            <form class="form-horizontal" role="form" id="editCategoryForm" method="POST" action="{{route('category.update',['category' =>'0'])}}">
                <div class="form-group">
                    <label class="col-md-2 control-label" for="cat">Category : </label>
                    <div class="col-md-6">
