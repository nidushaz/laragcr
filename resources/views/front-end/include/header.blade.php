            ...
            <div class="container">
				...
				<div class="collapse navbar-collapse cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="main-nav">
                        <ul class="nav navbar-nav pull-left">
							...
							<!-- Simple Menu Item -->
                            <li class="dropdown simple-menu">
                                <a href="{{route('solutions')}}" class="dropdown-toggle" >e-Catalog</a>
                            </li>
							<li class="dropdown simple-menu">
                                <a href="{{route('experience-centre')}}" class="dropdown-toggle">Experience Centre</a>
                            </li>
							<li class="dropdown simple-menu">
                                <a href="{{route('contact')}}" class="dropdown-toggle">Support</a>
                            </li>
							<li class="dropdown simple-menu">
							...
							<li class="dropdown simple-menu">
                                <a href="{{route('about-GCR')}}" class="dropdown-toggle" role="button">About GCR</a>
                            </li>
