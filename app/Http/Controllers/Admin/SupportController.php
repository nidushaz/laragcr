...
class SupportController extends Controller
{
    ...
    {
        $contacts = $contactService->getAllSupport();
        $isAuthorize = $checkPermissionService->checkPermission();

        return view('admin.supports',compact('contacts','isAuthorize'));
    }
    ...
    {
        $contact = $contactService->getSupportById($id);
        return view('admin.support',compact('contact'));
    }
