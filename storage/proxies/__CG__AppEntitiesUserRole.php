...
class UserRole extends \App\Entities\UserRole implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\UserRole' . "\0" . 'id', '' . "\0" . 'App\\Entities\\UserRole' . "\0" . 'roleId', '' . "\0" . 'App\\Entities\\UserRole' . "\0" . 'userId', '' . "\0" . 'App\\Entities\\UserRole' . "\0" . 'delete', '' . "\0" . 'App\\Entities\\UserRole' . "\0" . 'createdAt', '' . "\0" . 'App\\Entities\\UserRole' . "\0" . 'updatedAt'];
        }
