 ...
 */
class EventsAttachment extends \App\Entities\EventsAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\EventsAttachment' . "\0" . 'id', '' . "\0" . 'App\\Entities\\EventsAttachment' . "\0" . 'attachment', '' . "\0" . 'App\\Entities\\EventsAttachment' . "\0" . 'eventId', '' . "\0" . 'App\\Entities\\EventsAttachment' . "\0" . 'deleted', '' . "\0" . 'App\\Entities\\EventsAttachment' . "\0" . 'createdAt', '' . "\0" . 'App\\Entities\\EventsAttachment' . "\0" . 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventsAttachment $proxy) {
