...
class Videos extends \App\Entities\Videos implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Videos' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Videos' . "\0" . 'title', '' . "\0" . 'App\\Entities\\Videos' . "\0" . 'mediaUrl', '' . "\0" . 'App\\Entities\\Videos' . "\0" . 'tag', '' . "\0" . 'App\\Entities\\Videos' . "\0" . 'categoryId', '' . "\0" . 'App\\Entities\\Videos' . "\0" . 'deleted', '' . "\0" . 'App\\Entities\\Videos' . "\0" . 'isActive', '' . "\0" . 'App\\Entities\\Videos' . "\0" . 'createdAt'];
        }
