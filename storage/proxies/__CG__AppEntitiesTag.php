...
class Tag extends \App\Entities\Tag implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Tag' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Tag' . "\0" . 'tagName', '' . "\0" . 'App\\Entities\\Tag' . "\0" . 'deleted', '' . "\0" . 'App\\Entities\\Tag' . "\0" . 'createdAt', '' . "\0" . 'App\\Entities\\Tag' . "\0" . 'productTag'];
        }
    ...
    public function setProductTag($productTag)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProductTag', [$productTag]);

        return parent::setProductTag($productTag);
    }
