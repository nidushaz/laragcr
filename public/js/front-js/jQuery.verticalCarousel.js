...
(function($) {  
	$.fn.verticalCarousel = function(options) {  
		...
		return this.each(function() {
			...
			setInterval(function(){ console.log('hiee');
				//$(carouselDown).on("click", function(e){
					if (options.currentItem + options.showItems <= totalItems){
						moveCarousel("down");
					}
					$( ".leftSideBr ul li:nth-child(0)" ).insertBefore($('.leftSideBr ul li:nth-child(1)'));
					 console.log($( ".leftSideBr ul li:nth-child(0)" ).html());
					//e.preventDefault();
				//});
			}, 1000);
		});
